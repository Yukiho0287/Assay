...
const zh = {
  ...
  'login.feishu': '使用飞书登录',
  'login.redirecting': '正在跳转飞书登录…',
  'login.or': '或',
  'login.usePassword': '用密码登录',
  'login.hidePassword': '收起密码登录',
  'login.passwordHint': '管理员兜底通道，普通成员请用飞书登录',
  ...
  'users.username': '用户名',
  'users.role': '角色',
  'users.authSource': '认证方式',
  'users.authFeishu': '飞书',
  'users.authPassword': '密码',
  'users.feishuNoPassword': '飞书账号不设密码',
...
const en: Record<DictKey, string> = {
  ...
  'login.redirecting': 'Redirecting to Feishu…',
  'login.or': 'or',
  'login.usePassword': 'Sign in with password',
  'login.hidePassword': 'Hide password sign-in',
  'login.passwordHint': 'Admin fallback only — members should sign in with Feishu',
  ...
  'users.role': 'Role',
  'users.authSource': 'Sign-in',
  'users.authFeishu': 'Feishu',
  'users.authPassword': 'Password',
  'users.feishuNoPassword': 'Feishu accounts have no password',
